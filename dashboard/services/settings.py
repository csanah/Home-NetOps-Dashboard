...
SETTINGS_SCHEMA = {
    "layout": {
        ...
        "color": "teal",
        "fields": [
            {"key": "SHOW_MEDIA_CENTER", "label": "Media Center",    "type": "checkbox", "default": "true"},
            {"key": "SHOW_UDM",          "label": "UDM Pro",          "type": "checkbox", "default": "true"},
            {"key": "SHOW_PROXMOX",      "label": "Proxmox",          "type": "checkbox", "default": "true"},
            {"key": "SHOW_HA",           "label": "Home Assistant",    "type": "checkbox", "default": "true"},
            {"key": "SHOW_NAS",          "label": "Synology NAS",      "type": "checkbox", "default": "true"},
            {"key": "SHOW_MQTT",         "label": "MQTT Broker",       "type": "checkbox", "default": "true"},
        ],
        "tests": [],
    },
    "claude_chat": {
        ...
        "color": "violet",
        "fields": [
            {"key": "CLAUDE_CHAT_ENABLED", "label": "Show Chat Page", "type": "checkbox", "default": "true"},
    ...
    "dashboard": {
        ...
        "fields": [
            ...
            {"key": "DASHBOARD_PORT", "label": "Port", "type": "number", "default": "7000", "restart": True},
        ],
        "tests": [],
    },
    "udm": {
        ...
        "color": "indigo",
        "fields": [
            {"key": "SHOW_FIREWALL", "label": "Show Firewall Page", "type": "checkbox", "default": "true"},
    ...
    "overseerr": {
        ...
        "fields": [
            ...
            {"key": "OVERSEERR_HOST", "label": "Host", "type": "text", "default": "your_overseerr_ip"},
    ...
    "media_services": {
        ...
        "color": "amber",
        "fields": [
            {"key": "SHOW_DOWNLOADS", "label": "Show Downloads Page", "type": "checkbox", "default": "true"},
...
def test_connection(system):
    ...
    try:
        if system == "udm_api":
            ...
            host = os.environ.get("OVERSEERR_HOST", "your_overseerr_ip")
